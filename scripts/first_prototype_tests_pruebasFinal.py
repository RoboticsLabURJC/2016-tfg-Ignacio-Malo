...
def move_to_goal(color):
    ...
    '''ocm_forearm.link_name = "l_elbow_flex_link";
    ocm_forearm.header.frame_id = "base_link";
    ocm_forearm.orientation.w = 1.0;
    ocm_forearm.absolute_x_axis_tolerance = 0.1;
    ocm_forearm.absolute_y_axis_tolerance = 0.1;
    ocm_forearm.absolute_z_axis_tolerance = 0.1;
    ocm_forearm.weight = 1.0;
    test_constraints= moveit_msgs.msg.Constraints()
    test_constraints.orientation_constraints.append(ocm_forearm);
