...
def start_planning():
    ...
    p.addBox("obstacle1_1", 0.5, 0.02, 0.4, 0.65, 0.3, 0.95)
    p.addBox("obstacle1_2", 0.45, 0.01, 0.50, 0.3, 0.4, 0.3)
    p.addBox("obstacle1_3", 0.5, 0.02, 0.2, 0.65, 0.6, 0.65)
    #p.addBox("obstacle1_4", 0.65, 0.02, 0.2, 0.65, 0.6, 1.1)
    #p.addBox("obstacle1_3", 0.65, 0.02, 0.25, 0.65, 0.6, 0.675)
    #p.addBox("obstacle1_4", 0.65, 0.02, 0.2, 0.65, 0.6, 1.3)
    print group_left.get_planning_time()
    group_left.set_planning_time(40)
    #print group_left.get_num_planning_attempts()
...
def set_orientation_constraints(link, orientation, x_tol,y_tol,z_tol):
    ...
    group_left.set_path_constraints(test_constraints)
...
def move_to_goal(color):
    ...
    group_left.set_path_constraints(test_constraints);
    print(group_left.get_known_constraints);
    print(group_left.get_path_constraints);'''
    #start_planning()
